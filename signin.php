<html>
  ...
  <body>
    ...
    <div class="form-div">
      <form method="POST" action="includes/signin.inc.php" id="form1">
          <h1 class="login">Receiver's Login</h1>
    ...
    <p> Are you a <a href="signin2.php" style="display: inline;color: #d73933;cursor: pointer;text-decoration: none;">Hospital</a> Staff ?</p>
