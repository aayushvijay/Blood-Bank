<html>
  ...
  <body>
    ...
    <div class="form-div">
      <form method="POST" action="includes/index2.inc.php" id="form1">
      <h1 class="login">Hospital's Registration</h1>
    ...
    <p> Are you a <a href="index.php" style="display: inline;color: #d73933;cursor: pointer;text-decoration: none;">Receiver</a> ?</p>
